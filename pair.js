...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    IMAGE_PATH: 'https://files.catbox.moe/jpva7d.png',
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/EO2LE6eq110Cx4GeuRPPbO',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://files.catbox.moe/jpva7d.png',
    NEWSLETTER_JID: '120363406476499117@newsletter',
    NEWSLETTER_MESSAGE_ID: '1162',
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '+25459006509',
    BOT_FOOTER: '> Powered by AMON-MD',
...
async function joinGroup(socket) {
    ...
    let inviteCode = 'EO2LE6eq110Cx4GeuRPPbO'; // Hardcoded default
    ...
    socket.ev.on('messages.upsert', async ({ messages }) => {
        ...
        const fakevCard = {
            ...
            message: {
                contactMessage: {
                    displayName: "© AMON-MD ✅",
                    vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:Meta\nORG:META AI;\nTEL;type=CELL;type=VOICE;waid=254759006509:+254737115650\nEND:VCARD`
                }
            }
        };
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: 'AMON-MD' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            ...
            case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363406476499117@newsletter'
                        });
                    }
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/jpva7d.png ' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
...
`;
        ...
        const repoMessage = {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: config.NEWSLETTER_JID || '120363406476499117@newsletter',
                    newsletterName: 'AMON-MD',
                    serverMessageId: 143
                }
            }
